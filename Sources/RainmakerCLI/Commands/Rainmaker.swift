...
struct Rainmaker: AsyncParsableCommand {
    static let configuration: CommandConfiguration = {
        var subcommands: [any ParsableCommand.Type] = [Capabilities.self, CreateDirectory.self, Delete.self, Download.self, Info.self, List.self, Login.self, Move.self, Navigation.self, Notifications.self, Poll.self, Trash.self, Upload.self]
